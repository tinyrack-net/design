...
<ComponentExampleTabs
  ...
  title="Direction"
  description="Set swipeDirection to down, up, left, or right. The popup attaches to and dismisses toward the corresponding viewport edge. Left and right drawers use a borderless edge surface."
