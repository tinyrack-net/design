...
Set `highlight.themes` to any dark and light pair from `docsHighlightThemes` in `@tinyrack/docs/highlighting`. The build validates both ids and emits only the two selected theme chunks.
